        ...
        tls::Record {
            ...
            data: tls::Data::HandshakeProtocol(tls::HandshakeProtocol::ClientHello(
                ...
                vec![
                    ...
                    tls::Extension { type_: tls::ExtensionType::SessionTicketTLS },
                    tls::Extension { type_: tls::ExtensionType::SignatureAlgorithms },
                    tls::Extension { type_: tls::ExtensionType::EcPointFormats },
                    tls::Extension { type_: tls::ExtensionType::KeyShare },
                    tls::Extension { type_: tls::ExtensionType::PskExchangeModes },
                    tls::Extension { type_: tls::ExtensionType::SupportedVersions },
