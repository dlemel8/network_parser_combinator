...
mod tests {
    ...
    use crate::{dtls, parse, parse_ethernet_packet, tls, Protocol};
    ...
    #[test]
    fn parse_ethernet_packet_on_valid_dtls_change_cipher_spec_input_return_dtls_protocol(
    ) -> Result<(), Box<dyn Error>> {
    ...
    #[test]
    fn parse_ethernet_packet_on_valid_tls_application_input_return_tls_protocol(
    ) -> Result<(), Box<dyn Error>> {
